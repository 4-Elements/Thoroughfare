...
class CliServiceProvider extends service_provider_core_1.ServiceProviderCore {
    ...
    async getConnectionInfo() {
        ...
        const [buildInfo = null, atlasVersion = null, fcv = null] = await Promise.all([
        ...
        const extraConnectionInfo = (0, service_provider_core_1.getConnectInfo)((_b = (_a = this.uri) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '', version, buildInfo, atlasVersion, topology);
        return {
            buildInfo: buildInfo,
            topology: topology,
            extraInfo: {
