import type { ClientMetadata, ReadPreferenceFromOptions, ReadPreferenceLike, OperationOptions, RunCommandCursor, RunCursorCommandOptions } from 'mongodb';
...
declare class CliServiceProvider extends ServiceProviderCore implements ServiceProvider {
    ...
    private static getLibmongocryptBindings;
